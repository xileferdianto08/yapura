...
//        requestQueue = Volley.newRequestQueue(getApplicationContext());
    ...
    public void toStatus(View view){
        AlertDialog.Builder dialog = new AlertDialog.Builder(BarangActivity.this);
        ...
        dialog.setPositiveButton("Status alat", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(BarangActivity.this, StatusBarangUser.class));
            }
        });
        ...
        dialog.setNegativeButton("Status ruangan", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(BarangActivity.this, StatusRuanganUser.class));
            }
        });

...
public class JadwalAlatAdapter extends RecyclerView.Adapter<JadwalAlatAdapter.HolderItem> {
    List<jadwalAlatList> jAlat;
    Context context;

    public JadwalAlatAdapter(List<jadwalAlatList> jAlat, Context context) {
        this.jAlat = jAlat;
    ...
    public HolderItem onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.jadwal_alat_card, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderItem holder, int position) {
        jadwalAlatList lAlat = jAlat.get(position);
    ...
    public class HolderItem extends RecyclerView.ViewHolder{
        ImageView foto;
        TextView namaBarang, qty, startDate, startTime, endDate, endTime, necessity;
        Button btnBook;

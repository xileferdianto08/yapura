...
public class ListPeminjamanAlatAdapter extends RecyclerView.Adapter<ListPeminjamanAlatAdapter.HolderItem> {
    ...
    private static String URL_EDIT_STATUS = "https://yapuraapi.000webhostapp.com/yapura_api/barang/update_status_peminjaman.php";
